...
def testNewFunction(argv):
        ...
        for line in hostlist:
			...
			myvarlist = prepareVariables(myvars)
			print(myvarlist)
			command = "cd /opt/mule@@gwinstance@@/"
			print(convertCommand(myvarlist,command))	
